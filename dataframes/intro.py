...
"""
import pandas as pd
nba = pd.read_csv("Projects/python/pandas/data/nba.csv")
print(nba.shape)
print(nba.columns)
print(nba.axes)
print(nba.info())
...
import pandas as pd
revenue = pd.read_csv("Projects/python/pandas/data/revenue.csv", index_col="Date")
print(revenue.sum())
...
"""
import pandas as pd
nba = pd.read_csv("python/pandas/data/nba.csv")
print(nba[["Name", "Team"]])
...
"""
import pandas as pd
nba = pd.read_csv("python/pandas/data/nba.csv").dropna(how="all")
